...
class Team_user extends Model {
  ...
  public static function team_data($team_id) {
    ...
    $players = DB::table('team_user_players')
      ->select('team_users.id', 'team_user_players.player_id', 'team_user_players.name', 'team_user_players.last_name', 'team_user_players.position', 'team_user_players.points', 'team_user_players.name_opponent', 'team_user_players.salary', 'team_user_players.player_id')

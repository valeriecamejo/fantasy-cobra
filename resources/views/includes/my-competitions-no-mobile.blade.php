  ...
  <ul class="nav nav-tabs nav-tabsnull" role="tablist">
      <li role="presentation" class="active BtnLineup10">
        @if(isset(Auth::user()->id_tipousuario) && Auth::user()->id_tipousuario==3 && Auth::user()->active==1)
          <a href="#my-all-no-mobile" onclick="my_lobby(0,0)" aria-controls="home" role="tab" data-toggle="tab" style="cursor: pointer;">Todos</a>
        @else
          <a href="#my-all-no-mobile" onclick="my_lobby(0,1)" aria-controls="home" role="tab" data-toggle="tab" style="cursor: pointer;">Todos</a>
        @endif
      </li>
      <li role="presentation">
        @if(isset(Auth::user()->id_tipousuario) && Auth::user()->id_tipousuario==3 && Auth::user()->active==1)
          <a href="#my-baseball-no-mobile" onclick="my_lobby(1,0)" aria-controls="home" role="tab" data-toggle="tab" style="cursor: pointer;">Béisbol</a>
        @else
          <a href="#my-baseball-no-mobile" onclick="my_lobby(1,1)" aria-controls="home" role="tab" data-toggle="tab" style="cursor: pointer;">Béisbol</a>
        @endif
      </li>
      <li role="presentation">
        @if(isset(Auth::user()->id_tipousuario) && Auth::user()->id_tipousuario==3 && Auth::user()->active==1)
          <a href="#my-football-no-mobile" onclick="my_lobby(2,0)" aria-controls="home" role="tab" data-toggle="tab" style="cursor: pointer;">Fútbol</a>
        @else
          <a href="#my-football-no-mobile" onclick="my_lobby(2,1)" aria-controls="home" role="tab" data-toggle="tab" style="cursor: pointer;">Fútbol</a>
        @endif
      </li>
  </ul>
  <!-- Tab panes -->
  <div class="tab-content tab-contentnull tab-contenthome">
    <div role="tabpanel" class="tab-pane fade in active bordyel" id="my-all-no-mobile">
      <table class="table table-hover table-responsive" id="tabledesk">
        ...
        <tbody id="my-table-all-no-mobile">
          <!-- -------------------------------- DESTACADAS DE HOY -------------------------------- -->
          ...
          @foreach($featured_competitions_yesterday as $competition)
              <tr>
                  ...
                  <td class="notdpad">
                    <span id="{{$competition->id}}" style="font-weight: bold;">Finalizado</span>
                  </td>
                  <td class="tdentrar2">
                      @if(isset(Auth::user()->id_tipousuario) && Auth::user()->id_tipousuario==3 && Auth::user()->active==1)
                          @if($competition->season_format == 11)
                      ...
                      @else
                          ...
                          @endif
                      @endif
                                  <div class="BtnEntrar2" style="background-color: #c5c5c5;">ENTRAR</div>
                              </a>
                  </td>
              </tr>
          @endforeach

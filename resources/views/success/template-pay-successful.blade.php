                    ...
                    <div class="collapse navbar-collapse navbar-right">
                        <ul class="nav navbar-nav">
                            ...
                            @if(isset(Auth::user()->id_tipousuario) && Auth::user()->id_tipousuario==3 && Auth::user()->active==1)
                                ...
                                <span id="userbar">{{$_SESSION['username']}}
                                    {{ HTML::image('images/arrowd.png','flecha', array('class'=>'icon-arrow-down')) }}
                                </span>
                                        <span ></span>
                                        <span id="userbalance">
                                    Balance:
                                            {{-- */ $balance = explode(",",number_format($_SESSION['balance'],2,",",".")); /* --}}
                                            @if($balance[1] == 00)
                                                {{ number_format($_SESSION['balance'],0,"",".") }}
                                            @else
                                    ...
                                    <ul class="dropdown-menu" role="menu">
                                        <a href=".cajero" data-toggle="modal" class="dropdown-toggle" >
                                            ...
                                            <b>Bono:</b>
                                                    {{-- */ $bonus = explode(",",number_format($_SESSION['bonus'],2,",",".")); /* --}}
                                                    @if($bonus[1] == 00)
                                                        {{ number_format($_SESSION['bonus'],0,"",".") }}
                                                    @else
                                                        {{ number_format($_SESSION['bonus'],2,",",".") }}
                                                    @endif
                                                    Bs.
                                            </span>
                                            </li>
                                        ...
                                        <li onclick="document.getElementById('bloquea').style.display='block'">
                                            <a href="{{ URL::action('BettorController@edit_bettor') }}">Perfil Usuario</a>
                                        </li>
                                        <li onclick="document.getElementById('bloquea').style.display='block'">
